...
* Shell access whilst the container is running: `docker exec -it apprise-api /bin/bash`
* To monitor the logs of the container in realtime: `docker logs -f apprise-api`
...
* Update all images: `docker-compose pull`
  * or update a single image: `docker-compose pull apprise-api`
* Let compose update all containers as necessary: `docker-compose up -d`
  * or update a single container: `docker-compose up -d apprise-api`
* You can also remove the old dangling images: `docker image prune`

### Via Docker Run
* Update the image: `docker pull ghcr.io/linuxserver/apprise-api`
* Stop the running container: `docker stop apprise-api`
* Delete the container: `docker rm apprise-api`
...
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/linuxserver/apprise-api:latest .
```
